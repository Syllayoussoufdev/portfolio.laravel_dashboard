                    ...
                    <div class="row gx-5 align-items-center">
                        <div class="col-xxl-5">
                            ...
                            <div class="text-center text-xxl-start">
                                <div class="badge bg-gradient-primary-to-secondary text-white mb-4"><div class="text-uppercase">Programation  &middot; Designe &middot; Developement &middot; Marketing Digital &middot; App Mobile</div></div>
                                <div class="fs-3 fw-light text-muted">Développeur Web & Mobile Fullstack | Freelance web</div>
                                ...
                                <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                                    <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder" href={{ route('Resume') }}>Resumer / CV</a>
                        ...
                        <div class="col-xxl-7">
                            ...
                            <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                                <div class="profile bg-gradient-primary-to-secondary">
                                    ...
                                    <img class="profile-img" src="{{ asset('assets/images/profil1.png') }}" alt="..." />
                                    <div class="dots-1">
                                        <!-- SVG Dots-->
